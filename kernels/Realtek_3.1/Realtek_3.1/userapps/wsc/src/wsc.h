...
/*
enabled immediate mode pbc ; gpio will rx pbc event and trigger wscd by signal method
need enabled IMMEDIATE_PBC at rtl_gpio.c (sdk/linux/drivers/char/)
*/ 
...
#ifdef WPS2DOTX
#define VERSION_STR					"v2.8-wps2.0"
#else
#define VERSION_STR					"v2.8-wps1.0"
#endif
...
#if 1
#define ALD_RESET_TIME   	3600
#define ALD_START_INCRESE  	15	// for test
#define ALD_UNIT_TIME		60
#else
#define ALD_RESET_TIME   	70	// for test
#define ALD_START_INCRESE  6	// for test
#define ALD_UNIT_TIME		1	//for test
#endif
/*brute force attack mitigation*/
...
typedef struct context {
	...
	time_t ALD_recount_start_time;
	int brute_force_attack_mitigation;
	/*--------brute force attack mitigation--------------*/
#endif
